...
drawBoard([A,B,C,D,E,F,G,H,I]):- write('['), drawMove(A) , write(',') , drawMove(B) , write(',') , drawMove(C) , 
write(',') , drawMove(D) , write(',') , drawMove(E) , write(',') , drawMove(F) , write(',') , 
drawMove(G) , write(',') , drawMove(H) , write(',') , drawMove(I) , write(']').
...
start_it([o, Board, start_it], o, NewBoard):-
